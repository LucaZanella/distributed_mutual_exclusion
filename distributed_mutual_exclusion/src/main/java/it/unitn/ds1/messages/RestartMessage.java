...
/**
 * Represents a message sent from a node to each of its neighbors to reconstruct
 * the information, required for the algorithm, that got lost after the failure
 * of the node itself.
 */
